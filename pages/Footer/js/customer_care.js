    ...
    var sampleSlides = [
        {
            ...
            image: "./Images/img1.jpg" // Đường dẫn đến hình ảnh cho slide 1
        },
        {
            title: "Slide 2",
            body: "Nội dung cho slide 2",
            image: "./Images/img2.jpg" // Đường dẫn đến hình ảnh cho slide 2
        },
        {
            title: "Slide 3",
            body: "Nội dung cho slide 3",
            image: "./Images/img3.jpg" // Đường dẫn đến hình ảnh cho slide 3
        }
    ];
